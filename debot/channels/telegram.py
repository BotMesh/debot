...
from debot.bus import MessageBus, OutboundMessage
from debot.channels.base import BaseChannel
from debot.config.schema import TelegramConfig
from debot.session._manager_py import SessionManager  # Use Python version for compaction support
    ...
    async def _on_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        if media_file and self._app:
            try:
                ...
                media_dir = Path.home() / ".debot" / "media"
